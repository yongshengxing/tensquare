...
public class ArticleService {
    ...
    public Article findById(String id) {
        ...
        if (article== null){
            ...
            redisTemplate.opsForValue().set("article" + id, article,20,TimeUnit.SECONDS);
        }
     ...
     * @return
     */
    public List<Article> searchInfoByCondition(Article article) {
        return articleDao.findAll(new Specification<Article>() {
            @Override
            public Predicate toPredicate(Root<Article> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {

                ArrayList<Predicate> articles = new ArrayList<>();
                ...
                if (article.getContent() != null && !"".equals(article.getContent())) {
                    Predicate getContent = criteriaBuilder.like(root.get("content").as(String.class), "%" + article.getContent() + "%");
                    articles.add(getContent);
                }
                return criteriaBuilder.and(articles.toArray(new Predicate[articles.size()]));
    ...
    public void addThumbupNum(String articleId) {
        articleDao.addThumbupNum(articleId);
    }
    ...
    public void examineInfo(String articleId){
        articleDao.examineInfo(articleId);
    }
