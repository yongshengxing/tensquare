...
public class AdminService {
	...
	public Admin findByName(String loginName,String password){
		Admin dbAdmin = adminDao.findByLoginname(loginName);
		if (dbAdmin != null && encoder.matches(password,dbAdmin.getPassword() )) {
			return dbAdmin;
		}
		return null;
	}
